...
#undef NV_VMBUS_CHANNEL_HAS_RING_BUFFER_PAGE
#undef NV_DEVICE_DRIVER_OF_MATCH_TABLE_PRESENT
#undef NV_DEVICE_OF_NODE_PRESENT
#undef NV_NODE_STATES_N_MEMORY_PRESENT
...
#undef NV_ACPI_FADT_LOW_POWER_S0_FLAG_PRESENT
...
#undef NV_DRM_MODE_OBJECT_FIND_HAS_FILE_PRIV_ARG
...
#undef NV_DRM_GEM_OBJECT_HAS_RESV
#undef NV_DRM_CRTC_STATE_HAS_ASYNC_FLIP
#undef NV_DRM_CRTC_STATE_HAS_PAGEFLIP_FLAGS
#undef NV_DRM_FORMAT_MODIFIERS_PRESENT
#undef NV_DRM_VMA_NODE_IS_ALLOWED_HAS_TAG_ARG
